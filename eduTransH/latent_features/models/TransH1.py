...
#
from EmbeddingModel_1 import EmbeddingModel, register_model
...
class TransH(EmbeddingModel):
    ...
    def _fn(self, e_s, e_p, e_o):
        ...
        x_pos_tf, self.unique_entities, ent_emb_batch, weights = super.dataset_iterator.get_next()
        pos_norm = tf.nn.embedding_lookup(self.normal_vectors, x_pos_tf[:, 1])
